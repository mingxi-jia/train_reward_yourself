...
# Pretrained with BC
python train_reward_yourself/train_bc_agent.py --data=demos_with_images.hdf5 --env-name=LunarLander-v3 --output=ppo_lunar_demo10 --n-demos=10 --epochs=10
...
# Finetune with PPO
python train_reward_yourself/train_rl_agent.py --env-type gym --env-name LunarLander-v3  --n-envs 4 --algo ppo --timesteps 50000 --pretrain-model ppo_lunar_demo10.zip
